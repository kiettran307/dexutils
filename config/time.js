const config = {
  ...
  CRONJOB_57M_INTERVAL: '0 57 * * * *',
  CRONJOB_2M_INTERVAL: '0 2 * * * *',
  CRONJOB_23H_55M_INTERVAL: '0 57 23 * * *',
  CRONJOB_5M_TH_INTERVAL: '2 0,5,10,15,20,25,30,35,40,45,50,55 * * * *',
  CRONJOB_5M_TH_15S_INTERVAL: '15 0,5,10,15,20,25,30,35,40,45,50,55 * * * *',
  CRONJOB_5M_TH_10S_INTERVAL: '10 0,5,10,15,20,25,30,35,40,45,50,55 * * * *',
  ...
  H4: 14400, // seconds
  D1: 86400, // seconds
  EMIT_INTERVAL_HOUR: 3600, // 56th minute = 56 * 60
  EMIT_INTERVAL_DAY: 86400 // 56th minute = 56 * 60
};
